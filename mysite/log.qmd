...
<script>brender("(log2a 7 220 880)", "blocklyDiv6")</script>
...
<script>brender("(mapv log2 [1 2 4 8])", "blocklyDiv10")</script>
</td>
</tr></table>
</details>
:::
...
<script>brender("(mapv (partial log2a 7 220) [110 220 440 880])", "blocklyDiv14")</script>
</td>
</tr></table>
</details>
:::
...
<summary>15</summary>
```{python}
mapv(partial(log2a, 7, 220), [110, 220, 440, 880])
```
</details>
...
<script>brender("(:tiles/vert (mapv (log2b 7) [1 2 4]))", "blocklyDiv17")</script>
...
<td style="vertical-align: top">
<div style="height: 300px; width:230px; text-align: right">
<img src="myjs/xkcd_call.jpg" style="height: 300px"></img></div>
</td>
<td style="vertical-align: top">
<div id="blocklyDiv18" style="height: 300px; width: 800px"></div>
