...
---
<!--
Before publishing (according to README.md), switch to main branch and do (no commit needed in main for publishing the effects) :
* set cache to false
* outcomment scittle nrepl
* var notebook=true
* "/site/jsfiles/blockly/static/media/"
* "/site/jsfiles/GClef.svg"
* remove navigation in _quarto.yaml
* recreate log.ipynb (needs to be pushed in main so no /refs/head is needed in raw.github URL which is linked in log.qmd)
-->
...
* Walkthrough video for the notebook: <a href=https://www.youtube.com/watch?v=FE5pB3yvCRs target="_blank">https://www.youtube.com/watch?v=FE5pB3yvCRs</a>
