...
Sometimes, you need to start with the basics. I am sure you all have your own ways to do graphs. Now I'd like to show my approach. I needed to make a choice for the mathematical target to plot. It could have been anyone. I chose the musical scale. -- The notes are logarithmic. I figured that would make a good start.
</div>
</details>
...
To make the log2 fit the notes, you need to scale it accordingly. -- But I have jumped ahead. I need to plot the plain log2 first.
</div>
</details>
...
While I do worry that my viewers did not have the time to digest, I move on towards the practical goal. -- I need to get more to something like this. I need a scaled version of the log2.
</div>
...
To come up with this formula that I already showed at the beginning, I did lots of plots and trial and error and mistakes. The mistakes are the error part in trial and error. But I cannot plot a formula. The main theme again. I need a proper mathematical target to plot. -- To get such a target, I need to wrap this formula into a procedure. For this you have to make a decision. You have to choose names. Naming is hard. -- The procedure itself I gave the name Poe. It takes the arguments intersect, steps and the frequency x. -- The procedure returns the formula. -- You have to replace the numbers by the chosen names. -- I provide the procedure as Python code.
</div>
</details>
...
<script>
r19 = () => brender("(call (log2b 1 1) x0)", "blocklyDiv19");
var ws19 = r19();
