...
<script>
var state = {};
state['board1'] = JXG.JSXGraph.initBoard('jxg10', {
            boundingbox: [-20, -54, 20, -74],
            axis:true
        });
state['board1'].create('functiongraph', ['5/x - (50 + 14)'], {strokeColor:'red'});
</script>
...
<script>
state['board3'] = JXG.JSXGraph.initBoard('jxgLog', {
            boundingbox: [-5, 10, 70, -10],
            axis:true
        });
state['board3'].create('functiongraph', ['log(x)']);
state['board3'].create('line',[[64,0],[64,4.16]], {straightFirst:false, straightLast:false, strokeWidth:5, strokeColor:'#00ff00'});
</script>
